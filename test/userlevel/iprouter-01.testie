...
click-align IPR | click --simtime > OUT
echo '++p' | cat OUT - | dc > OUTA

click-xform -p IPR_PAT IPR | click-align | click --simtime > OUT
echo '++p' | cat OUT - | dc > OUTB
...
// Print stuff
DriverManager(wait_stop, print counter0.count, print out0.drops, print out0.length)
