...
//Print afterNDSol-output0 |  86 : 3333ff00 000100e0 2905e56f 86dd6000 00000020 3aff3ffe 1ce10002 00000000 00000000 0001ff02 00000000 00000000 0001ff00 00018700 b0840000 00003ffe 1ce10002 00000000 00000000 00010101 00e02905 e56f
...
d8 01 00 00  13 69 13 69>, 1, 5)
	...
	0::ffff:0:0/96 ::0 3,
  	::0/0 ::c0a8:1 4);
	nds :: NDSol(3ffe:1ce1:2::1, 00:e0:29:05:e5:6f);
	
	rt[1] 	-> Print(route1-ok, 200) 
		-> [0]nds;
		
	c[1] 	-> Print(c[1], 200) ->[1]nds;
	nds[0]-> Print(afterNDSol-output0, 200)
		->Discard;
