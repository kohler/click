...
Boolean. Set to false if you want ToDump to not use buffering when
saving data to a file.  This is unlikely to work with compressed dump
formats. Default is true.
