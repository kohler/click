...
/* Change Log
 * 5.7.4        01/11/05
 * - Add support for 82541ER device.
 * 5.7.2        12/17/04
 * - Fix APM issues with 82544 APM contents in EEPROM for 82544 based adapters 
 *   is different from that for later adapters.
 * 5.7.1	12/16/04
 ...
 * 5.6.10-1	12/06/04
 * - strip shared code not related to RK3
 * 5.6.11	12/03/04
 * - build.mk changes to generate drvnet.img for EM64T kernels
 * 5.6.10	11/23/04
